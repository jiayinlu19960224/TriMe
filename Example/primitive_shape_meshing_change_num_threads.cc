...
//------------------0.Set up parameters--------------------
    ...
    sprintf(case_name_base,"triangle_mesh_N_%d_K_%g_numTSetup_%d_numTMesh_%d",Ntotal,K,num_t_setup,num_t_mesh);
...
//-------------------2.Create shape------------------------
    ...
    shape_2d_triangle shp(con,num_t_setup,0.1,0.1,0.3,0.8,0.8,0.5);
